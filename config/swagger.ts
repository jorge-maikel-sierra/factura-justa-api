...
const projectRoot = path.join(url.fileURLToPath(new URL('.', import.meta.url)), '..')

export default {
  // Configuración específica de adonis-autoswagger
  path: projectRoot,
  specFilePath: path.join(projectRoot, 'docs/swagger.json'),
  tagIndex: 3,
  ...
  // Propiedades de la especificación OpenAPI (se fusionarán con lo autogenerado)
  openapi: '3.0.0',
  info: {
  ...
  externalDocs: {
    description: 'Encuentra más información sobre el proyecto',
    url: 'https://github.com/tu-usuario/factura-justa-api',
  },
  components: {
    securitySchemes: {
      bearerAuth: {
        ...
        scheme: 'bearer',
        bearerFormat: 'JWT',
        description: 'Token JWT obtenido al registrarse o iniciar sesión. Formato: Bearer {token}',
      },
    },
    schemas: {
      // Esquemas de Request
